...
const tailors = [
  {
    ...
    about: "Specialist in bridal blouses and lehengas with detailed handwork and perfect fitting.",
    rating: 4.8,
    services: [
      {
        ...
        priceFrom: 1200,
        duration: "7–10 days",
        description: "Heavy bridal blouses with hand embroidery, padding and perfect fitting for wedding functions."
      },
      {
        title: "Party Wear Blouse Stitching",
        priceFrom: 800,
        duration: "5–7 days",
        description: "Designer blouses with stylish neck and sleeve patterns for parties and receptions."
      },
      {
        title: "Lehenga Stitching",
        priceFrom: 3200,
        duration: "10–14 days",
        description: "Custom lehenga stitching with can-can, lining and detailed finishing for bridal and festive wear."
      },
      {
        title: "Quick Alterations",
        priceFrom: 200,
        duration: "1–2 days",
        description: "Minor size adjustments, length corrections and fitting fixes for existing garments."
      }
    ]
  },
  {
    ...
    about: "Creates modern ethnic and Indo-western outfits with a focus on comfort and clean silhouettes.",
    rating: 4.9,
    services: [
      {
        ...
        priceFrom: 1300,
        duration: "5–7 days",
        description: "Custom salwar suits with trendy necklines, sleeve styles and comfortable fits."
      },
      {
        title: "Indo-Western Gown Stitching",
        priceFrom: 2500,
        duration: "7–10 days",
        description: "Floor-length gowns with fusion designs suitable for cocktails and receptions."
      },
      {
        title: "Kurta & Pant Set Stitching",
        priceFrom: 1500,
        duration: "5–8 days",
        description: "Well-fitted straight kurtas with matching pants or palazzos for office and events."
      },
      {
        title: "Custom Designer Wear Consultation",
        priceFrom: 500,
        duration: "1–2 days",
        description: "Design consultation with sketch suggestions and fabric guidance for special occasions."
      }
    ]
  },
  {
    ...
    about: "Known for regal sherwanis and traditional menswear with intricate embroidery and rich fabrics.",
    rating: 4.7,
    services: [
      {
        ...
        priceFrom: 4500,
        duration: "12–18 days",
        description: "Heavily embroidered sherwanis with custom fitting for grooms and close family."
      },
      {
        title: "Simple Sherwani / Pathani Set",
        priceFrom: 2500,
        duration: "7–10 days",
        description: "Elegant sherwanis and pathani sets for nikah, engagements and festive functions."
      },
      {
  ...
  },
  {
    ...
    about: "Designs elegant lehengas and evening gowns with a contemporary touch for events and parties.",
    rating: 4.6,
    services: [
      {
        ...
        priceFrom: 2800,
        duration: "10–14 days",
        description: "Flowy gowns with modern cuts, ruffles and drapes for cocktail nights and parties."
      },
      {
        title: "Light Lehenga Stitching",
        priceFrom: 2200,
        duration: "8–12 days",
        description: "Lightweight lehengas suitable for mehendi, sangeet and festive functions."
      },
      {
        title: "Party Wear Dress Stitching",
        priceFrom: 1500,
        duration: "5–7 days",
        description: "Knee-length and midi dresses with trendy silhouettes for birthdays and outings."
      }
    ]
  },
  {
    ...
    about: "Tailors sharp, well-fitted suits and blazers for office, functions and special occasions.",
    rating: 4.5,
    services: [
      {
  ...
  },
  {
    ...
    about: "Offers neatly finished blouses, kidswear and quick alterations with reliable turnaround time.",
    rating: 4.6,
    services: [
      {
  ...
  },
  {
    ...
    about: "Focuses on traditional menswear with royal sherwanis and well-fitted kurtas for weddings and festivals.",
    rating: 4.7,
    services: [
      {
        title: "Wedding Sherwani Stitching",
  ...
  },
  {
    ...
    about: "Popular for colourful Navratri outfits and stylish lehengas with comfortable fits.",
    rating: 4.5,
    services: [
      {
        ...
        priceFrom: 1800,
        duration: "7–10 days",
        description: "Bright, flared chaniya cholis specially designed for Navratri with mirror work and borders."
      },
      {
  ...
  },
  {
    ...
    about: "Blends Rajasthani royal style with modern cuts for bandhgala suits and sherwanis.",
    rating: 4.8,
    services: [
      {
  ...
  },
  {
    ...
    about: "Designs modest yet stylish outfits including abayas and evening gowns with soft drapes.",
    rating: 4.4,
    services: [
      {
  ...
  },
  {
    ...
    about: "Experienced designer known for bridal trousseau, reception gowns and heavy designer blouses.",
    rating: 4.9,
    services: [
      {
  ...
  },
  {
    ...
    about: "Specialises in crisp office shirts and trousers with clean cuts and neat finishing.",
    rating: 4.3,
    services: [
      {
  ...
  },
  {
    ...
    about: "Creates comfortable daily wear suits and stylish blouses for working women and students.",
    rating: 4.4,
    services: [
      {
  ...
  },
  {
    ...
    about: "Young tailor who focuses on trendy streetwear, casual shirts and perfect denim alterations.",
    rating: 4.2,
    services: [
      {
  ...
  },
  {
    ...
    about: "Known for graceful bridal lehengas and reception gowns with balanced flair and comfort.",
    rating: 4.7,
    services: [
      {
        title: "Bridal Lehenga Stitching",
        priceFrom: 4800,
        duration: "15–20 days",
        description: "Graceful bridal lehengas with balanced flair, can-can and detailed can-finishing."
      },
      {
  ...
  },
  {
    ...
    about: "Offers made-to-measure suits and blazers for corporate events, interviews and functions.",
    rating: 4.5,
    services: [
      {
  ...
  },
  {
    ...
    about: "Focuses on comfortable daily and office wear with simple yet elegant designs.",
    rating: 4.3,
    services: [
      {
  ...
  },
  {
    ...
    about: "Creates festive kurta sets and Nehru jackets that are popular for poojas and family functions.",
    rating: 4.4,
    services: [
      {
  ...
  },
  {
    ...
    about: "Specialises in flowy Anarkalis, palazzo suits and Punjabi-style lehengas with rich fabrics.",
    rating: 4.6,
    services: [
      {
  ...
  },
  {
    ...
    about: "Offers tailored suits and formal shirts with subtle South-Indian styling for weddings and events.",
    rating: 4.7,
    services: [
      {
...
//--------------ORDER---------
const orders = [
  // Example structure (we'll mainly create via API):
  // {
  //   id: 1,
  //   userId: 1,              // optional for now (customer)
  //   tailorId: 1,
  //   garmentType: "Lehenga",
  //   fabricOption: "tailor",  // "customer" or "tailor"
  //   measurementMethod: "tailor", // "tailor" or "manual"
  //   measurements: { bust: 34, waist: 28, hip: 36, length: 40 },
  //   address: "Home address text",
  //   preferredDate: "2025-12-01",
  //   preferredTimeSlot: "evening",
  //   designNotes: "Sangeet outfit, pastel colours",
  //   designImageUrl: null,    // later we can store an upload path
